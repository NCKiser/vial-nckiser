...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		...
		KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, LT(2, KC_J), KC_K, KC_L, KC_ENT, 
		SFT_T(KC_Z), KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, SFT_T(KC_SLSH), 
		KC_LCTL, KC_LGUI, KC_LALT, KC_BSPC, LT(1, KC_SPC), KC_RALT, KC_RGUI, KC_RCTL),

	KEYMAP(
		KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, 
		KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, KC_BSLS, KC_TRNS, KC_LEFT, KC_UP, KC_DOWN, KC_RGHT, 
		KC_SCLN, KC_QUOT, KC_GRV, KC_CAPS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 
